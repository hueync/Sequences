...
def run_test_count_items_bigger_than():
    ...
    # Test 10:
    sequence = [11, 22, 10, 20, 33, 44, 5, 6, 7, 99, 100]
    threshold = 11
    expected = 6
    actual = count_items_bigger_than(sequence, threshold)
    print()
...
def run_test_count_positive_sines():
    ...
    expected = 3
    actual = count_positive_sines([ 13, 37, 4, 20, 1337, 420, 6, 66, 666, 6, 9, 69])
    print()
    print('Test 10 expected:', expected)
    print('        actual:  ', actual)
...
def run_test_sum_first_n():
    ...
    # Test 8:
    expected = 80
    actual = sum_first_n([13, 37, 4, 20, 6, 66], 5)
    print()
    print('Test 8 expected:', expected)
    print('       actual:  ', actual)
    ...
    # Test 9:
    expected = 104
    actual = sum_first_n([6, 9, 69, -4, -13, 37, 15], 6)
    print()
    print('Test 9 expected:', expected)
    print('       actual:  ', actual)
